...
# 2. Create a new AI Command with this content
# 3. Or paste in Raycast AI conversations
...
This file is designed for Raycast AI integration.

### Setup in Raycast

1. Open Raycast
2. Go to Extensions → AI Commands
3. Create new command with these instructions
4. Or paste in AI chat
...
**paracle-lite** - Governance & v1.0 Release (0%)
