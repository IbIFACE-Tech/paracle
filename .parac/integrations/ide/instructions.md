...
# Generated: 2026-01-07T15:37:17.586392
#
...
This file configures Google's Gemini CLI for Paracle projects.

### Setup

1. Install Gemini CLI: `npm install -g @google/gemini-cli`
2. Configure: `gemini config set instructions_file .gemini/instructions.md`
3. Use: `gemini ask "your question"`

### Paracle Integration

Access Paracle tools via MCP:
...
**Security Agent** (`security`): Security auditing, vulnerability detection, threat modeling, and security compliance enforcement for Paracle framework and AI applications.
