...
# 2. Paste at the start of your Claude.ai or Claude Desktop conversation
# 3. Or set as "Project Knowledge" in Claude.ai Projects
...
## Claude.ai / Desktop Usage

This file is designed for copy-paste into Claude.ai or Claude Desktop.

### Setup Options

**Option 1: Paste at conversation start**
Copy this entire file and paste as your first message.

**Option 2: Claude.ai Projects**
1. Go to Claude.ai
2. Create/open a Project
3. Add this as "Project Knowledge"

**Option 3: Claude Desktop**
1. Open Claude Desktop settings
2. Add this content to system instructions

### Key Files to Reference

When discussing this project, ask me to read:
- `.parac/memory/context/current_state.yaml` - Current state
- `.parac/roadmap/roadmap.yaml` - Priorities
- `.parac/agents/specs/{agent}.md` - Agent guidelines

### Available Agents

**System Architect Agent**: System architecture design, module structure, and technical decision making.
...
**Security Agent**: Security auditing, vulnerability detection, threat modeling, compliance enforcement, and security standards implementation for Paracle framework and AI applications.
**Agent Specification Template**: [Describe the agent's primary function in 1-2 sentences]
**Tester Agent**: Test design, implementation, and quality validation ensuring comprehensive coverage and reliability.
...
paracle ide sync        # Regenerate this file
```
