...
The fastest way to learn Paracle is with our interactive tutorial:

```bash
paracle tutorial start
```

This 30-minute guided experience covers:

- **Step 1**: Create your first agent (interactive prompts)
- **Step 2**: Add tools (filesystem, http, shell, python, search)
- **Step 3**: Add skills (custom capabilities)
- **Step 4**: Create templates (reusable project scaffolding)
- **Step 5**: Test your agent (configure API key, dry run)
- **Step 6**: Create workflow (multi-agent orchestration)

**Tutorial Commands:**

```bash
paracle tutorial start       # Start from beginning
paracle tutorial resume      # Continue where you left off
paracle tutorial status      # Check your progress
paracle tutorial reset       # Start over
```

Progress is saved automatically. Take breaks and resume anytime!
