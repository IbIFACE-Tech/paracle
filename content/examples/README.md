...
- **[basics/](basics/)** - Getting started with core tools and concepts
- **[agents/](agents/)** - Agent creation, configuration, and inheritance
- **[tools/](tools/)** - Tool registry and plugin development
- **[workflows/](workflows/)** - Workflow orchestration and conflict resolution
- **[security/](security/)** - Sandboxing, network isolation, and security features
- **[git/](git/)** - Git workflows, commits, and pre-commit hooks
- **[observability/](observability/)** - Monitoring, profiling, and observability
- **[advanced/](advanced/)** - Advanced features (HITL, multi-provider, caching, etc.)
- **[governance/](governance/)** - Logging, compliance, and governance

## ⭐ Featured Example: Agent Inheritance

**File**: [`agents/real_world_inheritance.py`](agents/real_world_inheritance.py)
...
```bash
uv run python content/examples/agents/real_world_inheritance.py
```
...
```bash
# From project root
uv run python content/examples/basics/01_filesystem_tools.py
```
...
Located in [`observability/`](observability/):
...
Located in [`governance/`](governance/):
...
### 1. Filesystem Tools (`basics/01_filesystem_tools.py`)
