...
class FireworksProvider(LLMProvider):
    ...
    Ultra-fast inference for production-grade AI applications.
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if not api_key:
            raise ValueError(
                "Fireworks API key required. Set FIREWORKS_API_KEY or "
    ...
    async def chat_completion(
        ...
        **kwargs: Any,
        ...
        """Generate chat completion using Fireworks."""
        formatted_messages = [
...
_fireworks_provider = ProviderInfo(
    provider_id="fireworks",
    display_name="Fireworks.ai",
    description="Production-grade AI inference with competitive pricing",
...
get_model_catalog().register_provider(_fireworks_provider)
